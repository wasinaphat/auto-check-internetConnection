...
import (
	...
	"github.com/wasinapl/bookstore_users-api/utils/crypto_utils"
	"github.com/wasinapl/bookstore_users-api/utils/date_utils"
...
func (s *usersService) GetUser(userId int64) (*users.User, *errors.RestErr) {
		...
		result := &users.User{Id:userId} //create object 
...
func (s *usersService) DeleteUser(userId int64)*errors.RestErr  {
	user := &users.User{Id:userId} //create object 
	return user.Delete()
